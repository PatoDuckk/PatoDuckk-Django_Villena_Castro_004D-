...
class Categoria_Prod(models.Model):
    ...
    nombre = models.CharField(max_length=15, verbose_name="Nombre para las categorias de plantas")
    def __str__(self):
        return self.nombre

class Producto(models.Model):
    codPlanta= models.CharField(max_length=8,primary_key=True,verbose_name="Código de las Plantas")
    nomPlanta= models.CharField(max_length=30, verbose_name="Nombre descripción de Plantas")
    categoria = models.ForeignKey(Categoria_Prod, on_delete=models.CASCADE)
    foto= models.ImageField(verbose_name="Foto de la planta")
    def __str__(self):
        return self.nomPlanta
